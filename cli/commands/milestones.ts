...
milestonesCommand
  ...
  .action(async (goalId: string) => {
    const items = await apiGet<Milestone[]>(`/api/goals/${goalId}/milestones`);
...
milestonesCommand
  ...
  .action(async (id: string) => {
    const milestone = await apiGet<Milestone>(`/api/milestones/${id}`);
...
milestonesCommand
  ...
  .action(async function (this: Command, id: string) {
    ...
    const milestone = await apiPatch<Milestone>(`/api/milestones/${id}`, data);
