  ...
  return (
    <div className="text-center py-12 px-6">
      ...
      <p className="text-gray-600 mb-6 max-w-md mx-auto">
        Goals with milestones are{" "}
        <span className="font-semibold text-amber-700">3x more likely</span> to
        be completed. Break down your goal into achievable steps.
      </p>
      ...
      {/* Subtle testimonial/social proof */}
      <p className="text-xs text-gray-500 mt-6 italic">
        &ldquo;Breaking my goals into milestones was the game-changer I
        needed.&rdquo; - Sarah K.
      </p>
    </div>
  );
}
